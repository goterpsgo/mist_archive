...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, _app) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        _app = Flask(__name__)
        db = SQLAlchemy(_app, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(_app)).
        """
